...
/fix --quick [3D scene performance - reduce draw calls and optimize geometries]
...
```bash
# Add mobile support
/fix [3D scene] - optimize for mobile with reduced quality and touch controls
...
- [/design:good](/docs/engineer/commands/design/good) - High-fidelity 2D design
- [/design:fast](/docs/engineer/commands/design/fast) - Quick prototypes
- [/fix](/docs/engineer/commands/fix/ui) - Fix 3D visual issues
