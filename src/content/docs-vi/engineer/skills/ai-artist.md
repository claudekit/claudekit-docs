---
title: "ck:ai-artist"
description: Viết và tối ưu hóa prompts cho kết quả AI-generated trên các mô hình text và image cho LLMs, image generators và video generators
section: engineer
kit: engineer
category: skills
order: 50
...
> Tạo prompts hiệu quả cho các mô hình AI text và image generation với các patterns và kỹ thuật đã được chứng minh.

## Skill Này Làm Gì

AI Artist cung cấp hướng dẫn prompt engineering toàn diện cho cả các LLM text-based (Claude, GPT, Gemini) và các mô hình generative media (Midjourney, DALL-E, Stable Diffusion, Imagen, Flux, Veo). Skill này giúp bạn cấu trúc prompts tạo ra outputs nhất quán, chất lượng cao bằng cách áp dụng các patterns đã được chứng minh về clarity, context và iteration.
...
- User đề cập đến các AI model như Claude, GPT, Midjourney, DALL-E, Stable Diffusion
...
Cấu trúc prompts cho các AI model text-based sử dụng pattern role-context-task-format:
...
Tạo prompts cho các AI model visual với cấu trúc subject-style-composition-quality:
...
Các model khác nhau có parameter syntax riêng:
...
**Chỉ định output format rõ ràng**: Markdown, JSON, CSV, bullet points, v.v. Tránh format ambiguity.
...
**Tránh conflicting constraints**: "Detailed but concise" mâu thuẫn nhau. Hãy chọn một.

## Anti-Patterns

- **Hướng dẫn mơ hồ**: "Làm cho nó tốt hơn" không cung cấp tiêu chí đo lường được
- **Conflicting constraints**: "Professional but casual tone" gây confusion
...
**Vấn đề**: Outputs không nhất quán qua các lần chạy.

**Giải pháp**: Thêm explicit constraints, few-shot examples, hoặc tăng temperature/randomness settings nếu được hỗ trợ.

---

**Vấn đề**: Image generation bỏ qua chi tiết quan trọng.

**Giải pháp**: Dùng weighted tokens `(keyword:1.3)` trong Stable Diffusion hoặc đặt chi tiết quan trọng ở đầu prompt cho Midjourney.

---

**Vấn đề**: LLM responses quá dài dòng.

**Giải pháp**: Thêm explicit length constraint: "Giới hạn response ở 3 câu" hoặc "Tối đa 200 từ."

---

**Vấn đề**: AI hiểu sai creative direction.

**Giải pháp**: Cung cấp visual hoặc textual references: "Theo style của Apple's product pages" hoặc đính kèm reference images.

## Các Skills Liên Quan

- [AI Multimodal](/vi/docs/engineer/skills/ai-multimodal) - Xử lý và phân tích images, audio, video, PDFs với Gemini
- [Frontend Design](/vi/docs/engineer/skills/frontend-design) - Implement designs từ AI-generated mockups
- [Creativity](/vi/docs/engineer/skills) - Các workflows tạo nội dung sáng tạo
