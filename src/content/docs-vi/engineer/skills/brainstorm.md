---
title: "ck:brainstorm"
description: "Brainstorming giải pháp với phân tích đánh đổi, quyết định kiến trúc và sự thẳng thắn về tính khả thi"
section: engineer
kit: engineer
category: skills
order: 2
...
1. **Scout Phase**: Hiểu trạng thái hiện tại của dự án qua docs và code
2. **Discovery Phase**: Câu hỏi làm rõ về requirements và constraints
3. **Research Phase**: Thu thập thông tin từ docs, search và các agents khác
4. **Analysis Phase**: Đánh giá nhiều phương án sử dụng YAGNI/KISS/DRY
5. **Debate Phase**: Trình bày options, thách thức các sở thích, tìm giải pháp tối ưu
6. **Consensus Phase**: Đảm bảo đồng thuận về phương án đã chọn
7. **Documentation Phase**: Tạo báo cáo tóm tắt toàn diện
