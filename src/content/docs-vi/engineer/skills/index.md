...
#### [systematic-debugging](/vi/docs/engineer/skills/tools/systematic-debugging)
...
[→ Hướng dẫn đầy đủ về systematic-debugging](/vi/docs/engineer/skills/tools/systematic-debugging)
...
#### [nextjs](/vi/docs/engineer/skills/frontend/nextjs)
...
[→ Hướng dẫn đầy đủ về Next.js](/vi/docs/engineer/skills/frontend/nextjs)

---

#### [shadcn-ui](/vi/docs/engineer/skills/frontend/shadcn-ui)
...
[→ Hướng dẫn đầy đủ về shadcn-ui](/vi/docs/engineer/skills/frontend/shadcn-ui)

---

#### [tailwindcss](/vi/docs/engineer/skills/frontend/tailwindcss)
Framework CSS ưu tiên tiện ích (utility-first).

**Sử dụng khi:** Thiết kế phong cách cho ứng dụng.

[→ Hướng dẫn đầy đủ về Tailwind CSS](/vi/docs/engineer/skills/frontend/tailwindcss)
...
#### [postgresql-psql](/vi/docs/engineer/skills/backend/postgresql-psql)
...
[→ Hướng dẫn đầy đủ về PostgreSQL](/vi/docs/engineer/skills/backend/postgresql-psql)
...
#### [docker](/vi/docs/engineer/skills/backend/docker)
...
[→ Hướng dẫn đầy đủ về Docker](/vi/docs/engineer/skills/backend/docker)
