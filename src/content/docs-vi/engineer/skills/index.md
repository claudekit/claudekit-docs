...
#### [systematic-debugging](/vi/docs/engineer/skills/debug)
...
[→ Hướng dẫn đầy đủ về debug](/vi/docs/engineer/skills/debug)
...
#### [web-frameworks](/vi/docs/engineer/skills/web-frameworks)
...
[→ Hướng dẫn đầy đủ về Web Frameworks](/vi/docs/engineer/skills/web-frameworks)

---

#### [ui-styling](/vi/docs/engineer/skills/ui-styling)
...
[→ Hướng dẫn đầy đủ về UI Styling](/vi/docs/engineer/skills/ui-styling)

---

#### [ui-styling](/vi/docs/engineer/skills/ui-styling)
Framework CSS ưu tiên tiện ích (utility-first) và shadcn/ui components.
...
#### [databases](/vi/docs/engineer/skills/databases)
Quản trị và tối ưu hóa cơ sở dữ liệu PostgreSQL và MongoDB.

**Sử dụng khi:** Làm việc với cơ sở dữ liệu PostgreSQL hoặc MongoDB.
...
[→ Hướng dẫn đầy đủ về Databases](/vi/docs/engineer/skills/databases)
...
#### [devops](/vi/docs/engineer/skills/devops)
Nền tảng container hóa, triển khai và quản lý hạ tầng.

**Sử dụng khi:** Đóng gói ứng dụng, tạo Dockerfile, Docker Compose, triển khai Cloudflare/GCP.
...
[→ Hướng dẫn đầy đủ về DevOps](/vi/docs/engineer/skills/devops)
...
| **Ví dụ** | better-auth, docker | /ck:cook, /ck:debug, /ck:plan |
