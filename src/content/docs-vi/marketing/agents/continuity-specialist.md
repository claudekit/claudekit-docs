---
title: "Chuyên gia Duy trì (Continuity Specialist)"
description: "Chuyên gia duy trì khách hàng của bạn, tập trung vào ngăn ngừa rời bỏ, tái tương tác, chấm điểm sức khỏe khách hàng và các chương trình khách hàng thân thiết"
section: marketing
category: agents
order: 9
lang: vi
...
- [Email Wizard](/vi/docs/marketing/agents/email-wizard) - Các chuỗi email duy trì khách hàng
- [Lead Qualifier](/vi/docs/marketing/agents/lead-qualifier) - Phân tích vòng đời khách hàng
- [Upsell Maximizer](/vi/docs/marketing/agents/upsell-maximizer) - Mở rộng trong các tài khoản đã duy trì
