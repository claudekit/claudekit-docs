...
- [Marketing Skills](/vi/docs/marketing/skills) - Các kỹ năng truy cập nhanh cho nhiệm vụ marketing.
- [Marketing Workflows](/vi/docs/workflows) - Hướng dẫn từng bước cho các kịch bản phổ biến.
- [Marketing Skills](/vi/docs/marketing/skills) - Các khả năng chuyên biệt mà đại lý có thể kích hoạt.
- [Analytics Skill](/docs/marketing/skills/analytics) - Theo dõi các chiến dịch và số liệu phân tích.
