---
title: "Đại lý Chuyên gia Phân tích (Lead Qualifier)"
description: "Chuyên gia chấm điểm khách hàng tiềm năng, phát hiện ý định, phân tích hành vi và dự đoán mức độ sẵn sàng mua hàng."
section: marketing
category: agents
order: 3
lang: vi
...
- [Attraction Specialist](/vi/docs/marketing/agents/attraction-specialist) - Tạo khách hàng tiềm năng ở đầu phễu (TOFU)
- [Email Wizard](/vi/docs/marketing/agents/email-wizard) - Các chuỗi email nuôi dưỡng khách hàng tiềm năng
- [Sales Enabler](/vi/docs/marketing/agents/sale-enabler) - Tài liệu hỗ trợ bán hàng cho khách hàng đã được thẩm định
