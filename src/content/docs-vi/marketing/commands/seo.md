...
> Tối ưu hóa độ hiển thị tìm kiếm với SEO audits được tạo bằng AI và khuyến nghị
...
**Điều gì sẽ xảy ra**:
1. Tìm nạp page content và metadata
2. Phân tích technical SEO factors
3. Kiểm tra backlinks, traffic, keywords (nếu MCP connected)
4. Tạo prioritized recommendations với scores

**Kết Quả**: `assets/seo/audits/251229-example-com-audit.md`
...
| Hành Động | Mô Tả | Target | Kết Quả | Thời Gian Tiết Kiệm |
|--------|-------------|--------|--------|------------|
