...
/ckm:write:blog "10 Chiến Lược Giá SaaS" --style casual-founder
...
/ckm:video:create "Demo sản phẩm cho trang chủ"

# Tạo script video
/ckm:video:script "Giải thích API rate limiting" --duration=60 --platform=youtube
...
# Đề xuất chiến dịch
/ckm:slide:create "Q1 product launch campaign với phân tích ngân sách"
