...
Tuân theo quy ước đặt tên từ skill `brand-guidelines` để tìm kiếm dễ hơn.
...
- [Brand Guidelines](/vi/docs/marketing/skills/brand-guidelines) - Xác nhận tài sản và ngữ cảnh thương hiệu
- [AI Multimodal](/vi/docs/marketing/skills/ai-multimodal) - Tạo tài sản mới
- [Design](/vi/docs/engineer/skills/frontend/frontend-design) - Tạo tài sản thiết kế
