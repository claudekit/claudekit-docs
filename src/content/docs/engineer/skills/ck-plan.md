...
After scaffolding a plan, agents must read the generated `plan.md` and every `phase-*.md` before writing details into them. This keeps template sections, frontmatter, and phase contracts intact instead of overwriting unseen stubs.
