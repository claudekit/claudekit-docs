...
- [ai-multimodal](/docs/engineer/skills/ai-multimodal) - Analyze document images with AI
- [gemini-vision](/docs/engineer/skills/ai-multimodal) - OCR and visual document analysis
- [research](/docs/engineer/skills/research) - Extract insights from documents
- [repomix](/docs/engineer/skills/repomix) - Package documents for AI analysis
