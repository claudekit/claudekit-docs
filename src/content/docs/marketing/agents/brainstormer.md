---
title: "Brainstormer"
description: "Turn vague ideas into validated marketing strategies through systematic exploration and debate"
section: marketing
category: agents
order: 4
---
...
**Bad:** "Let's launch on Product Hunt"
**Good:** "Let's drive 1,000 signups via Product Hunt launch, success = 500+ upvotes and 30+ feedback comments"
...
- [Campaign Manager](/docs/marketing/agents/campaign-manager) - Execute multi-channel campaigns after strategy is defined
- [Content Reviewer](/docs/marketing/agents/content-reviewer) - Quality check campaign assets before launch
- [Campaign Debugger](/docs/marketing/agents/campaign-debugger) - Troubleshoot underperforming campaigns post-launch

## Related Commands

- `/ckm:plan` - Create comprehensive marketing plan
- `/ck:research` - Deep-dive research on topics, competitors, or strategies
