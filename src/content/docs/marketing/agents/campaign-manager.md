...
description: "Orchestrate multi-channel marketing campaigns with unified planning, tracking, and optimization"
section: marketing
category: agents
order: 2
---
...
**Work together with:**
- [Copywriter](/docs/marketing/agents/copywriter) - Write campaign messaging and copy
- [Content Creator](/docs/marketing/agents/content-creator) - Produce blogs, videos, assets
- [Email Wizard](/docs/marketing/agents/email-wizard) - Build email sequences
- [Social Media Manager](/docs/marketing/agents/social-media-manager) - Plan social calendars
- [Analytics Analyst](/docs/marketing/agents/analytics-analyst) - Deep-dive performance analysis

**Hand off to:**
- [Campaign Debugger](/docs/marketing/agents/campaign-debugger) - When campaigns underperform and you need root cause analysis
