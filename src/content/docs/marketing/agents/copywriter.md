---
title: "Copywriter"
description: "Create high-converting, viral-worthy copy that stops scrolls and drives action across all channels"
section: marketing
category: agents
order: 3
---
...
**Good:** "Ship features 10x faster - 6 minutes instead of 6 hours"

Specific numbers, outcomes, and timeframes build credibility.

### 2. Lead with Benefits, Not Features

**Bad:** "Built on Claude Opus 4.5 with multi-agent orchestration"
**Good:** "Your AI dev team ships in 6 minutes what takes you 6 hours"

Features are how it works. Benefits are why it matters.

### 3. Write for Humans, Not Algorithms

**Bad:** "Best AI-powered code generation tool for developers 2025"
**Good:** "Stop writing boilerplate. Start shipping features."

SEO-stuffed copy kills conversions. Write for readers first.

## Related Agents

- [Content Creator](/docs/marketing/agents/content-creator) - Long-form content (blogs, videos, scripts)
- [Email Wizard](/docs/marketing/agents/email-wizard) - Email sequences and automation
- [Social Media Manager](/docs/marketing/agents/social-media-manager) - Social calendars and multi-platform strategy
- [Campaign Manager](/docs/marketing/agents/campaign-manager) - Multi-channel campaign orchestration
- [Content Reviewer](/docs/marketing/agents/content-reviewer) - Quality check copy before publishing
