...
**What happens**:
1. AI asks about demographics, pain points, goals
2. Researcher validates with market data
3. Analyzes behavior patterns
4. Generates comprehensive persona profile
