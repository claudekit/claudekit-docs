...
Visual storyboards generated by the [`/ckm:video:storyboard`](/docs/marketing/commands/video#videostoryboard) command:
...
Presentations created with [`/ckm:slide:create`](/docs/marketing/commands/slide):
