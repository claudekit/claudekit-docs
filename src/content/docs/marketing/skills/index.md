...
| [SEO Optimization](/docs/marketing/skills/seo) | Technical SEO and keyword research | Google Search Console API, ReviewWeb.site API, Core Web Vitals, programmatic SEO |
...
| [Campaign Management](/docs/marketing/skills/campaign) | Multi-channel campaign execution | Campaign briefs, budget allocation, launch checklists, post-mortems |
...
| [Brand Guidelines](/docs/marketing/skills/brand) | Brand consistency and asset management | Brand voice, visual identity, asset organization, color systems |
...
**Example**: Content Creator agent implicitly loads `content-marketing`, `copywriting`, `brand` skills.
...
**Examples**:
```
Activate seo skill to audit site performance and identify keyword opportunities
```
...
- `campaign` - Orchestration and tracking
...
**4. Brand Consistency**
Always load `brand` skill when creating customer-facing content.
