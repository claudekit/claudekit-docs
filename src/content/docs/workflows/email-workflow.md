...
- [Content Workflow](/docs/workflows/content-workflow) - Create email content with quality gates
- [Sales Workflow](/docs/workflows/sales-workflow) - Lead nurture email sequences
- [Campaign Workflow](/docs/workflows/campaign-workflow) - Email as campaign channel
- [Analytics Workflow](/docs/workflows/analytics-workflow) - Measure email performance
