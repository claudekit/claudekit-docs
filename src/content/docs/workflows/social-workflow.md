...
description: "Social media content planning, creation, scheduling, and optimization across multiple platforms"
section: workflows
category: marketing
order: 9
---
...
- [Content Workflow](/docs/workflows/content-workflow) - Create social content with quality gates
- [Campaign Workflow](/docs/workflows/campaign-workflow) - Social as campaign channel
- [Brand Workflow](/docs/workflows/brand-workflow) - Ensure brand consistency
- [Analytics Workflow](/docs/workflows/analytics-workflow) - Track social performance
